...
class SetCriterion(nn.Module):
    ...
    def loss_sted(self, outputs, inter_idx, positive_map, time_mask=None):
    ...
    def loss_guided_attn(
        self, outputs, inter_idx, positive_map, time_mask=None
    ):
        ...
        **kwargs,
        ...
        if loss in ["sted", "guided_attn"]:
            return loss_map[loss](
                outputs, inter_idx, positive_map, time_mask, **kwargs
            )
